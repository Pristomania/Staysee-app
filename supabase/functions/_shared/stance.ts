...
const STANCE_GUIDANCE: Record<ConversationStance, string> = {
  ...
  named_presence:
    "РЕЖИМ: короткая реплика с уже названным чувством или состоянием. Используй слово человека — не добавляй новый оттенок. ЗАПРЕЩЕНО без её слов: тяжело, пусто, болезненно, перегруз, волна, напряжение, «настоящая», метафоры. 1–2 предложения, макс. один вопрос. Вопрос открытый, не меню вариантов и не перечисление оттенков: «Какая эта грусть сейчас?» · «Грусть сейчас рядом. Она про что-то или просто есть?» · «Злость — про что она сейчас?» · «Тревога сейчас больше мыслит за тебя или просто фонит?» · «Можно пока и не знать.» — по смыслу реплики. Развилка «X или Y?» — изредка, максимум два варианта, не в каждом ответе подряд. Если чувство уже названо — без гипотезы «похоже на X — так?».",
  ground:
