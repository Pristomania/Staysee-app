...
export function buildTimeGapPrompt(
  ...
  if (tier === "soft") {
    rules.push(
      ...
      "Не делай это каждый раз. Если тема острая и поток живой — можно не упоминать паузу вообще.",
      "Если упоминаешь — одна короткая живая фраза своими словами, затем отклик по сути. Примеры тона (не копируй дословно):",
